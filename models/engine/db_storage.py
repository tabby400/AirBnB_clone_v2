...
class DBStorage:
    ...
    def new(self, obj):
        """adding the object  the current db session"""
        if obj is not None:
            try:
    ...
    def save(self):
        """committing all changes of the current databse"""
        self.__session.commit()

    def delete(self, obj=None):
        """deleting from the current databse session the object"""
        if obj is not None:
    ...
    def close(self):
        """closing the working SQLAlchemy"""
